...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap transition-all disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0",
  {
    variants: {
      ...
      size: {
        small: 'h-6 px-2 rounded-400 text-body-2',
        medium: 'h-8 px-3 rounded-400 text-body-2',
        large: 'h-10 px-4 rounded-400 text-body-2',
        extraLarge: 'h-12 px-6 rounded-400 text-title-subhead-3',
      },
    },
    defaultVariants: {
      variant: 'primary',
