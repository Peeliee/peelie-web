  ...
  return (
    <div className="relative h-[400px] w-full overflow-hidden rounded-large bg-gray-01">
      ...
      <div className="absolute left-1/2 top-[28px] flex -translate-x-1/2 flex-col items-center gap-3">
        <ModalCharacterIcon />
        <div className="flex flex-col items-center text-center whitespace-nowrap text-body-2 font-medium text-gray-99">
      ...
      <img
        ...
        alt=""
        className="absolute left-1/2 top-[151px] h-[145px] w-[210px] -translate-x-1/2 object-contain"
      />
      ...
      <button
        type="button"
        onClick={onHome}
        className="absolute left-[28px] top-[324px] flex h-12 w-[264px] items-center justify-center rounded-full bg-gray-70 text-body-2 text-gray-01"
      >
        홈으로
      </button>
    </div>
