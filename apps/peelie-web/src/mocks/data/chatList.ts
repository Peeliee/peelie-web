...
export const ChatListMock: { data: ChatListItem[]; delay: number } = {
  ...
  data: [
    {
      chatRoomId: 'chr_001',
      friend: { id: 'usr_001', name: '클로드', personality: 'STRAIGHT_SHOOTER', isWithdrawn: false, isFriend: true },
    ...
    {
      chatRoomId: 'chr_002',
      friend: { id: 'usr_002', name: '지피티', personality: 'QUIET_CHARMER', isWithdrawn: false, isFriend: true },
    ...
    {
      chatRoomId: 'chr_003',
      friend: { id: 'usr_003', name: '제미나이', personality: 'ENERGETIC_TALKER', isWithdrawn: false, isFriend: true },
